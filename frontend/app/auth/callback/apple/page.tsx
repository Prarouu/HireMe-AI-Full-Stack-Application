...
import { appleCallback } from "@/services/auth";
...
const Spinner = () => (
  <div className="min-h-screen bg-[#0a0b0f] flex items-center justify-center">
    <div className="flex flex-col items-center gap-4">
      ...
      <p className="text-sm text-white/40">Signing you in with Apple...</p>
    </div>
  </div>
);
