  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="flex flex-col items-center mb-8 gap-3">
        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#4DA2FF] to-[#3a8fe8] flex items-center justify-center text-base font-bold text-white shadow-[0_0_32px_rgba(77,162,255,0.35)]">
          H
        </div>
        ...
        <p className="text-sm text-white/40">
          {mode === "signup"
            ...
            : "Sign in to your HirePilot AI dashboard."}
        </p>
      </div>

      <div className="card-border p-5 md:p-7 flex flex-col gap-4">

        {/* Social buttons */}
        <button
          type="button"
          onClick={handleGoogle}
          className="w-full flex items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/04 px-4 py-2.5 text-sm font-medium text-white/80 transition-all hover:border-white/20 hover:bg-white/07 hover:text-white active:scale-[0.98]"
        >
          <GoogleIcon />
          {verb} with Google
        </button>
        ...
        <p className="text-center text-sm text-white/35">
          {mode === "signup" ? (
            <>
              ...
              <Link href="/login" className="text-[#4DA2FF] hover:text-[#6fbcf0] transition-colors">
                Sign in
              </Link>
            </>
          ) : (
            <>
              ...
              <Link href="/signup" className="text-[#4DA2FF] hover:text-[#6fbcf0] transition-colors">
                Sign up
              </Link>
            </>
          )}
